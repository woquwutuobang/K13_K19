...
p <- ggplot(df, aes(x = residual_K27, y = residual_RAF1)) +
  ...
  coord_cartesian(xlim = c(-1.6, 2.3), ylim = c(-2, 1.9))

print(p)

ggsave("C:/Users/36146/OneDrive - USTC/Manuscripts/K13_K19/figures/figure5/20251025/f5a Correlation of Residuals between K27 and RAF1.pdf",
