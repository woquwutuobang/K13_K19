...
# K19 assay
result_k19 <- calculate_distance_residuals(
...
#names(result_k13)
#### 
ddG_k19<-fread("C:/Users/36146/OneDrive - USTC/DryLab/MoCHI_8binders_l2_e6_RA_old_new_merge_at_mochi_20250901/task_901/weights/weights_Binding_K19.txt")
#names(ddG_k19)
ddG_k19<-ddG_k19[,Pos_real:=Pos+1]
ddG_k19 <- ddG_k19[, c(1,20,23)]
colnames(ddG_k19)[2] <- paste0(colnames(ddG_k19)[2], "_", assay_sele1)

setnames(result_k19, "original_y",  paste0("mean_kcal/mol_", assay_sele1))

merge_k19<-merge(ddG_k19,result_k19,by=c("Pos_real","mean_kcal/mol_K19"),all=F)
...
merge_k13<-merge(ddG_k13,result_k13,by=c("Pos_real","mean_kcal/mol_K13"),all=F)

#names(merge_raf1)

data_plot<-merge(merge_k19,merge_k13,by=c("Pos_real","id","Pos"),suffixes = c(paste0("_", assay_sele2), paste0("_", assay_sele1)),all=F)
...
ggsave("C:/Users/36146/OneDrive - USTC/Manuscripts/K13_K19/figures/figure5/20251028/f5a Correlation of Residuals between K13 and K19 (excluded interface sites).pdf",
