...
for (i in 1:(length(successful_binders)-1)) {
  for (j in (i+1):length(successful_binders)) {
    ...
    # 直接使用所有数据
    df_cor <- all_residuals[, .SD, .SDcols = c(residual_col1, residual_col2)]
...
# 保存图表
ggsave("C:/Users/36146/OneDrive - USTC/Manuscripts/K13_K19/figures/20251031_version_all_figure/f6/20251103/Binder_Residual_Correlations_Grouped_per_mutation_fixed_order with 2BIs.pdf",
...
# ===============================
ggsave(
  filename = "C:/Users/36146/OneDrive - USTC/Manuscripts/K13_K19/figures/20251031_version_all_figure/f6/20251103/Binder_Residual_Correlations_Grouped_per_mutation_multilayer_sorted with 2BIs.pdf",
