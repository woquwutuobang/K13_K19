...
p <- ggplot(df, aes(x = residual_K13, y = residual_K19)) +
  ...
  coord_cartesian(xlim = c(-1.7, 2.3), ylim = c(-1.3, 2.1))

print(p)

ggsave("C:/Users/36146/OneDrive - USTC/Manuscripts/K13_K19/figures/figure5/20251025/f5a Correlation of Residuals between K13 and K19.pdf",
