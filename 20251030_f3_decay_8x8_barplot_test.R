...
create_parameter_plot <- function(results_data, parameter = c("a_value", "b_value"), 
  ...
  p <- ggplot(plot_data, aes(x = assay, y = .data[[parameter]], fill = group)) +
    ...
    labs(
      ...
      x = "A bar chart showing the results of the exponential decay fitting",
      y = paste0(parameter, " value"),
      fill = "Group"
    ) +
    theme_minimal() +
    theme(
...
results <- analyze_all_assays_cross(
  ...
  anno_file = "C:/Users/36146/OneDrive - USTC/DryLab/base_information_for_K13_K19_project/anno_final_for_8.csv",  
    output_file = "C:/Users/36146/OneDrive - USTC/Manuscripts/K13_K19/figures/figure3/20251030/exponential_fit_results 3.csv"
)

# 创建图表
all_plots <- plot_all_parameters(results, 
                                 "C:/Users/36146/OneDrive - USTC/Manuscripts/K13_K19/figures/figure3/20251030/parameter_comparison 4.pdf")
